...
export const registryItems: RegistryItem[] = [
  ...
  },
  {
    ...
    "type": "registry:ui",
    "title": "Generic Form",
    "description": "A schema-driven generic form built on react-hook-form and Zod. Wraps useForm with a zod resolver, shares the instance through FormProvider, and exposes a imperative ref API. Ships with a TextField input, an AsyncSelectField and an AsyncMultiSelectField for single-line, async single-select and multi-select fields.",
    "dependencies": [
      "react-hook-form",
      "zod",
      "@hookform/resolvers"
